...
`$ go run TeslaCommand.go -checkInterval=5 -fromAddress="from@anywhere.com" -geoFenceLatitude=33.921063 -geoFenceLongitude=-118.33015434 -mailServer="smtp.gmail.com" -mailServerLogin="user@gmail.com" -mailServerPassword="thepassword" -mailServerPort=587 -radius=200 -teslaLoginEmail="user@anywhere.com" -teslaLoginPassword="the-teslamotors-password" -toAddress="to@anywhere.com" -vehicleIndex=0`
